...
```
signed_tx_base64  ──sha256──▶  signed_tx_hash_sha256
                                      │
agent_did | skill_did | amount_minor | currency | signed_tx_hash_sha256
                                      │
                               (business sign payload)
                                      │
                              wallet signs this ──▶  signature field
```
